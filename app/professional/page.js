        ...
        <main className="min-h-screen overflow-x-hidden bg-gradient-to-b from-[#F7F3EB] via-[#FCF8F2] to-[#FCF8F2]">
            ...
            <section className=" text-center py-20  ">
                ...
                <h1 className=" max-w-4xl mx-auto text-center text-6xl font-serif text-[#143B35] leading-tight">
                    Grow your wellness practice with
                    <br />
                    early provider access.
                </h1>

                <p className="max-w-4xl mx-auto text-center text-gray-500 mt-6">
                    Apply to become part of a trusted at-home wellness marketplace <br /> launching in selected Canadian regions.
                </p>

                <Link href={"/early-access"}><button className="mt-8 bg-[#D8A44D] text-white px-8 py-3 rounded-full">
            ...
            <section className="max-w-7xl mx-auto"  >
                ...
                <div className="grid lg:grid-cols-2 gap-10 ">
                    ...
                    {/* Benefits Card */}
                    <div className="bg-[] rounded-[32px] p-10 shadow-sm">

                ...
                <div className=" relative py-24 bg-[#FBF8F3] overflow-hidden max-w-5xl mx-auto px-6">
                    ...
                    <div className="text-center mb-12">
                        ...
                        <p className="mt-4 text-gray-500 max-w-2xl mx-auto">
                           Thank you for applying. Our team will review your information and contact you with next steps when provider onboarding begins.
                        </p>
                    </div>
                </div>
                <div className="flex justify-center">
                    ...
                    <Link href="/services">
                        <button type="submit" className=" px-5 py-2 rounded-full bg-[#D8A44D] text-white text-sm">
                            Explore Services
                        </button>
                    </Link>
                </div>
